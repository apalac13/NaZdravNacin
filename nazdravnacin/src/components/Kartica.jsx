...
export default function Kartica({ index, card }) {
  return (
    <motion.div
      ...
      className="w-60 h-60 border border-green-10 rounded-xl bg-white-20 flex flex-col sm:gap-5 gap-3 items-center xs:justify-start justify-center p-3  shadow-lg cursor-pointer transition delay-150 duration-300 ease-in-out hover:scale-105"
    >
